...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <br />
        <asp:Button ID="insertBtn" runat="server" Text="Add Stationery" CssClass="form-button" OnClick="insertBtn_Click" />
    </div>
    ...
    <div runat="server" style="display: flex; flex-direction: row; gap: 48px;">
        <asp:GridView ID="StationeryGV" runat="server"
            ...
            Style="padding: 4px; margin-top: 24px; border-radius: 8px 8px 0 0; background-color: rgba(255, 255, 255, 0.9);">
            <Columns>
                <asp:BoundField
